...
import (
	...
	"go-micro.dev/v4"
	getArea "ihome-client/proto/getArea"
	getImg "ihome-client/proto/getImg"
	houseMicro "ihome-client/proto/house"
	register "ihome-client/proto/register"
	user "ihome-client/proto/user"
	orderMicro "ihome-client/proto/userOrder"
	"ihome-client/utils"
	"image/png"
	"net/http"
	"path"
